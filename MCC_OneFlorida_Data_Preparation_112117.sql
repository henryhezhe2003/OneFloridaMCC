/* CREATE A TABLE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 (PATID, AGE, SEX, HISPANIC, RACE, CONDITION, ENC_TYPE, ADMIT_DATE, C_WT); 'C_WT' IS USED FOR CALCULATING COMORBIDITY INDEX */

DROP TABLE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721;

PRINT 'table1, before delete' 

CREATE TABLE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721
(
PATID VARCHAR(64),
AGE INT,
...
INSERT INTO HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 (PATID, AGE, AGE_GROUP, SEX, HISPANIC, RACE, ETHNICITY, CONDITION, ENC_TYPE, ADMIT_DATE, C_WT)
...
FROM [ONEFLDW_20170221_CERT].[DBO].[DIAGNOSIS] C, [ONEFLDW_20170221_CERT].[DBO].[DEMOGRAPHIC] D
...
/* REVISED ACQUIRED HYPOTHYROIDISM ALGORITHM */
...
/* REVISED ACUTE MYOCARDIAL INFARCTION ALGORITHM */
...
/* REVISED ALZHEIMERS DISEASE ALGORITHM */
...
/* REVISED ALZHEIMERS DISEASE AND RELATED DISORDERS OR SENILE DEMENTIA ALGORITHM */
...
UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET AGE_GROUP ='65_74' WHERE AGE >= 65 AND AGE <= 74;

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET AGE_GROUP ='75_84' WHERE AGE >= 75 AND AGE <= 84;

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET AGE_GROUP ='ABOVE_85' WHERE AGE >= 85;

/* ASSIGNING VALUES TO ETHNICITY */

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET ETHNICITY ='NON_HISPANIC_WHITE' WHERE RACE = '05' AND HISPANIC ='N';

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET ETHNICITY ='NON_HISPANIC_BLACK' WHERE RACE = '03' AND HISPANIC ='N';

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET ETHNICITY ='ASIAN_PI' WHERE HISPANIC ='N' AND (RACE = '02' OR RACE = '04');

UPDATE HCUP.dbo.PATIENT_CONDITION_ENCTYPE_20170721 SET ETHNICITY ='HISPANIC' WHERE HISPANIC ='Y';
